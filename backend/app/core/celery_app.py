...
# Crear instancia de Celery solo si Redis está configurado
celery_app = None
...
if settings.CELERY_BROKER_URL:
    ...
    # Celery no configurado - las alertas del dashboard funcionan igual
    # pero las tareas programadas no se ejecutarán
    pass
