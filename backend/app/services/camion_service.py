...
def enriquecer_camion(camion: Camion) -> dict:
    ...
    camion_dict = {
        "id": camion.id,
        "categoria": camion.categoria or "camion",  # IMPORTANTE: incluir categoría
        ...
        "horas_promedio_diarias": camion.horas_promedio_diarias,
        ...
        "ultimo_servicio_horas": camion.ultimo_servicio_horas,
        "proximo_servicio_km": camion.proximo_servicio_km,
        "proximo_servicio_horas": camion.proximo_servicio_horas,
        "proximo_servicio_fecha": camion.proximo_servicio_fecha,
        "intervalo_servicio_km": camion.intervalo_servicio_km,
        "intervalo_servicio_horas": camion.intervalo_servicio_horas,
